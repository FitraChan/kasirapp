...
class Coba3 extends StatefulWidget {
  @override
  ProdukModel produkModel;
  Coba3({Key? key, required this.produkModel}) : super(key: key);
  _ShoeHomePageState createState() => _ShoeHomePageState();
}

class _ShoeHomePageState extends State<Coba3> {
  File? imageFile;
  String status = '';
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        value: (_mySelection == null || _mySelection!.isEmpty)
                            ? null
                            : _mySelection,
                      ),
                    ),
